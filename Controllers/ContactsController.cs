...
namespace TimeShareProject.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public ContactsController(TimeShareProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> UpdateContactStatus(int id, bool status)
        {
            ...
            return Ok(); // You can return any response to indicate success
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Phone,Email,Message,Status")] Contact contact)
        {
            if (id != contact.Id)
            {
                return NotFound();
